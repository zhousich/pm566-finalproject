...
```{r}
#| output: false
# Summary Statistics for Counties in California 
covid_county %>%
  group_by(county) %>%
...
```{r}
#| output: false
# Top 5 vaccinated counties in California
...
# Top 5 least vaccinated counties in California
...
```{r fig.height=7}
#| output: false
# Percent Fully Vaccinated by 2023-05-09
covid_county1 %>%
...
#| output: false
#| warning: false
#Population Density vs. Cummulative Cases
covid_county1 %>% 
...
#| output: false
#| warning: false
# Area Median Income by Percent Fully Vaccinated
